...
namespace {
struct qt_meta_tag_ZN6TetrisE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN6TetrisE = QtMocHelpers::stringData(
    "Tetris",
    "gameLoop",
    "",
    "startGame",
...
Q_CONSTINIT static const uint qt_meta_data_ZN6TetrisE[] = {
...
Q_CONSTINIT const QMetaObject Tetris::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6TetrisE.offsetsAndSizes,
    qt_meta_data_ZN6TetrisE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6TetrisE_t,
        // Q_OBJECT / Q_GADGET
...
void *Tetris::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6TetrisE.stringdata0))
